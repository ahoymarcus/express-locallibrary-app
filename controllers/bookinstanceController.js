...
exports.bookinstance_update_get = function(req, res, next) {
	...
	async.parallel({
		...
		// Success
		res.render('bookinstance_form', { title: 'Update BookInnstance', book_list : results.books, selected_book : results.bookinstance.book._id, bookinstance:results.bookinstance });
	});
};
